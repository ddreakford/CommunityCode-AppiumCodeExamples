        ...
        try {
            ...
            try {
                ...
                if (exceptionType.contains("UnsupportedCommandException") ||
                    ...
                    AccessibilityResultsUtil.saveResults(mockScanResult, "Android", "Android_ExperiBank_Accessibility_Scan_Demo");
            ...
            AccessibilityResultsUtil.saveResults(axeSupport, "Android", "Android_ExperiBank_Accessibility_Scan");
